        ...
        >
            <div className="space-y-2">
                <div className="flex justify-between align-center">
                    ...
                    <label className="font-semibold px-4 py-2 rounded hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                        <span className="mt-2 text-base leading-normal">Upload XML</span>
                        <input type='file' className="hidden" accept=".xml" onChange={(event) => handlexmlfileupload(event)} />
                    </label>
                </div>
...
function FormFieldCard({
    ...
    return (
        ...
        >
            <span
                className={`text-xs uppercase ${isSelected ? "text-gray-400" : "text-gray-500"
                    }`}
            >
                {type}
            </span>
