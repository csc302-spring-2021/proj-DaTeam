...
function Nav() {
    const [currentPage, setCurrentPage] = useState<string>("responses"); // default page
    const history = useHistory();
    console.log(history);

    const handPageChange = (page: string): void => {
        setCurrentPage(page);
        history.push("/" + page);
    }
            ...
            <div className="flex flex-row">
                <div className="flex-shrink-0 flex-col w-16 h-screen bg-black shadow-2xl">
                    <svg 
                        ...
                        className="hover:text-purple-500 text-white m-4 py-1" 
                    ...
                    <svg 
                        ...
                        onClick={() => {handPageChange("home")}} 
                        className={currentPage === "home" ? "text-purple-400 m-4 py-1" : "hover:text-purple-400 text-white m-4 py-1"}
                        xmlns="http://www.w3.org/2000/svg" 
                        fill="none" 
                        viewBox="0 0 24 24" 
                        stroke="currentColor">
                    ...
                    <svg 
                        ...
                        onClick={() => {handPageChange("responses")}} 
                        className={currentPage === "responses" ? "text-purple-400 m-4 py-1" : "hover:text-purple-400 text-white m-4 py-1"}
                        xmlns="http://www.w3.org/2000/svg" 
                        fill="none" 
                        viewBox="0 0 24 24" 
                        stroke="currentColor">
                    ...
                    <svg 
                        ...
                        onClick={() => {handPageChange("forms")}} 
                        className={currentPage === "forms" ? "text-purple-400 m-4 py-1" : "hover:text-purple-400 text-white m-4 py-1"}
                        xmlns="http://www.w3.org/2000/svg" 
                        fill="none" 
                        viewBox="0 0 24 24" 
                        stroke="currentColor">
