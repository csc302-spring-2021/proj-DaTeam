...
function Responses() {
  return (
    ...
    <div className="-mx-4 flex h-screen">
      <div className="overflow-y-auto w-full p-4 sm:w-1/2 lg:w-1/4 bg-white rounded-lg shadow-2xl">
      ...
      <div className="overflow-y-auto w-full p-4 sm:w-1/2 lg:w-1/2 bg-white rounded-lg shadow-2xl">
        <Form/>
      </div>
    </div>
  </div>
